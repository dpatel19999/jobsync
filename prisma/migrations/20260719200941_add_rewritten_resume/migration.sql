...
CREATE TABLE "new_Job" (
    ...
    CONSTRAINT "Job_coldEmailId_fkey" FOREIGN KEY ("coldEmailId") REFERENCES "ColdEmail" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Job_rewrittenResumeId_fkey" FOREIGN KEY ("rewrittenResumeId") REFERENCES "RewrittenResume" ("id") ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT "Job_automationId_fkey" FOREIGN KEY ("automationId") REFERENCES "Automation" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Job" ("applied", "appliedDate", "atsScore", "atsScoreData", "automationId", "coldEmailId", "companyId", "coverLetterId", "createdAt", "createdVia", "description", "discoveredAt", "discoveryStatus", "dueDate", "emailTo", "id", "jobSourceId", "jobTitleId", "jobType", "jobUrl", "language", "locationId", "matchData", "matchScore", "resumeId", "salaryRange", "statusId", "tailoredSummary", "userId", "workplaceType") SELECT "applied", "appliedDate", "atsScore", "atsScoreData", "automationId", "coldEmailId", "companyId", "coverLetterId", "createdAt", "createdVia", "description", "discoveredAt", "discoveryStatus", "dueDate", "emailTo", "id", "jobSourceId", "jobTitleId", "jobType", "jobUrl", "language", "locationId", "matchData", "matchScore", "resumeId", "salaryRange", "statusId", "tailoredSummary", "userId", "workplaceType" FROM "Job";
DROP TABLE "Job";
